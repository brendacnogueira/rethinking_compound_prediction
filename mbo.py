...
from ml_utils import get_promising_candidates
...
class ModelBasedOptimizationAlgorithm(ABC):
    ...
    def run(self, X_nxp: np.array, gt_n: np.array, ground_truth_fn, init_oracle: Oracle, init_searchmodel: SearchModel,
        ...
        #mean, cov=init_searchmodel.get_parameters()
        ...
        for t in range(n_iter):
           ...
           # trajectory.update(t, ot_m, gtt_m, iw_n, mboweights_m, set_m, selected_alpha,
            ...
            if t < n_iter - 1:
                ...
                mboweights_m_final= get_importance_weights(X_nxp, init_searchmodel, searchmodel, iw_alpha=selected_alpha, z_nxl=ztr_nxl)
                

        return mboweights_m_final
